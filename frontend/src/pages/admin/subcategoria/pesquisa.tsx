...
const PesquisaSubcategorias = () => {
    ...
    return(
        <div className="container-chamado">
            ...
            <TitleResult descricao="subcategoria" quantidade={page ? page.totalElements : 0} caminho="subcategoria" />
                ...
                <table className="table table-striped table-sm">
                    ...
                    {page?.content.map((subcategoria) => (
                        <tr key={subcategoria.codigo}>
                            ...
                            <td className="coluna-pequena">
                                <BiTrash onClick={() => handleDelete(subcategoria.codigo)} title="Excluir" className="icone-excluir" />
                            </td>
                        </tr>
                    ))}
                    </tbody>
